      ...
      <nav className="flex items-center justify-between px-6 py-4 md:px-12 lg:px-24 bg-[#1a1a1a]/80 backdrop-blur-xl sticky top-0 z-[100] border-b border-white/5 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.8)]">
        ...
        >
          <img
            ...
            className="w-20 h-20 md:w-24 md:h-24 object-contain drop-shadow-[0_0_10px_rgba(224,147,122,0.2)]"
          />
        </a>
        <div>
          <a
            href="#"
            className="text-sm font-bold text-[#1a1a1a] bg-[#e0937a] px-6 py-3 rounded-sm hover:bg-[#efe7dd] hover:shadow-[0_0_20px_rgba(224,147,122,0.4)] transition-all duration-300"
          >
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24 max-w-4xl mx-auto relative">
        <style
          dangerouslySetInnerHTML={{
            __html: `
          .datenschutz-content h1 { font-family: 'Playfair Display', serif; font-size: 2.5rem; color: #e0937a; margin-bottom: 2.5rem; font-weight: bold; text-transform: uppercase; letter-spacing: 0.05em; }
          .datenschutz-content h2 { font-size: 1.5rem; color: #efe7dd; margin-top: 3rem; margin-bottom: 1.5rem; border-bottom: 1px solid rgba(224,147,122,0.2); padding-bottom: 0.5rem; font-weight: 600; }
          .datenschutz-content h3 { font-size: 1.25rem; color: #e0937a; margin-top: 2rem; margin-bottom: 1rem; font-weight: 500; }
          .datenschutz-content h4 { font-size: 1.125rem; color: #efe7dd; margin-top: 1.5rem; margin-bottom: 0.75rem; font-weight: 500; }
          .datenschutz-content p { color: #d1d5db; font-weight: 300; line-height: 1.8; margin-bottom: 1.5rem; }
          .datenschutz-content a { color: #e0937a; text-decoration: none; transition: all 0.3s ease; }
          .datenschutz-content a:hover { text-decoration: underline; color: #efe7dd; }
          .datenschutz-content ul { list-style-type: disc; padding-left: 1.5rem; color: #d1d5db; font-weight: 300; margin-bottom: 1.5rem; line-height: 1.8; }
    ...
    <div className="min-h-screen bg-[#1a1a1a] text-[#efe7dd] font-['Montserrat',sans-serif] selection:bg-[#e0937a] selection:text-[#1a1a1a]">
      ...
      <nav className="sticky top-0 z-[100] flex items-center justify-between px-6 py-4 md:px-12 lg:px-24 bg-[#1a1a1a]/80 backdrop-blur-xl border-b border-white/5 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.8)] transition-all duration-300">
        <div className="flex items-center">
          <img
            src="https://lh3.googleusercontent.com/d/1dj4_0mNEvkggbx4UsJRX0-BE25gBR-ol"
            alt="Yagibasan Capital Logo"
            className="w-24 h-24 md:w-28 md:h-28 object-contain cursor-pointer hover:scale-105 transition-transform drop-shadow-[0_0_10px_rgba(224,147,122,0.2)]"
          />
        </div>
        <div className="hidden md:flex items-center gap-4">
          <a
            ...
            className="text-sm font-bold text-[#e0937a] border border-[#e0937a]/50 px-6 py-3.5 rounded-sm hover:border-[#e0937a] hover:bg-[#e0937a]/10 hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(224,147,122,0.2)] transition-all duration-300 inline-block"
          >
            Kostenloses Erstgespräch
          </a>
          <a
            href="#premium"
            className="text-sm font-bold text-[#1a1a1a] bg-[#e0937a] px-8 py-3.5 rounded-sm hover:bg-[#efe7dd] hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(224,147,122,0.6)] transition-all duration-300 inline-block"
          >
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start text-left">
            <div className="flex flex-col items-center mx-auto md:mx-0 mb-12 mt-4">
              <img
                src="https://lh3.googleusercontent.com/d/1dj4_0mNEvkggbx4UsJRX0-BE25gBR-ol"
                alt="Yagibasan Capital Logo"
                className="w-64 md:w-72 h-auto mb-6 object-contain drop-shadow-[0_10px_20px_rgba(224,147,122,0.15)]"
              />
              <p className="text-[#e0937a] text-xs md:text-sm font-bold tracking-[0.4em] uppercase drop-shadow-[0_0_8px_rgba(224,147,122,0.4)] text-center">
            ...
            <h1 className="mb-14 leading-[1.1]">
              ...
              <span className="block text-[#e0937a] font-serif-elegant italic text-5xl md:text-6xl lg:text-7xl mt-8 drop-shadow-[0_0_15px_rgba(224,147,122,0.3)]">
            ...
            <div className="border-l-4 border-[#e0937a] pl-6 py-4 mb-10 bg-gradient-to-r from-[#e0937a]/15 to-transparent rounded-r-lg shadow-[inset_10px_0_20px_-10px_rgba(224,147,122,0.3)]">
              ...
              <p className="text-lg md:text-xl font-medium text-[#e0937a] mt-2">
            ...
            <div className="flex flex-col w-full sm:flex-row gap-5">
              <a
                href="#about"
                className="flex items-center justify-center gap-2 bg-[#e0937a] text-[#1a1a1a] font-bold px-8 py-4 rounded-sm hover:bg-[#efe7dd] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(224,147,122,0.6)] transition-all duration-300"
              >
                Meine Geschichte
              </a>
              <a
                href="#depot"
                className="flex items-center justify-center gap-2 border-2 border-[#e0937a] text-[#e0937a] font-bold px-8 py-4 rounded-sm hover:bg-[#e0937a] hover:text-[#1a1a1a] hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(224,147,122,0.4)] transition-all duration-300"
              >
                Mein Depot-Einblick
              </a>
            </div>
      ...
      <div className="w-full bg-[#0a0a0a] py-12 px-6 text-center border-y border-[#e0937a]/10 relative overflow-hidden">
        ...
        <p className="relative z-10 text-xl md:text-2xl font-serif-elegant italic text-[#efe7dd] max-w-4xl mx-auto leading-relaxed px-4">
          ...
          gepflanzt.“
          <span className="block mt-4 text-sm font-sans font-bold text-[#e0937a] tracking-widest uppercase not-italic">
            — Warren Buffett
          </span>
        </p>
      </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
          <div className="w-full lg:w-5/12">
            ...
            <h3 className="mb-10 leading-[1.3]">
              ...
              <span className="block text-[#e0937a] font-serif-elegant italic text-3xl md:text-4xl lg:text-5xl drop-shadow-[0_0_12px_rgba(224,147,122,0.3)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#111] border border-white/5 p-10 rounded-2xl hover:border-[#e0937a]/40 hover:bg-gradient-to-br hover:from-[#111] hover:to-[#e0937a]/15 hover:-translate-y-2 hover:shadow-[0_15px_40px_-10px_rgba(224,147,122,0.4)] transition-all duration-500 group">
              <div className="w-14 h-14 bg-[#e0937a]/10 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(224,147,122,0.5)] transition-all">
                <Brain className="w-7 h-7 text-[#e0937a]" />
              </div>
              <h4 className="text-2xl font-serif-elegant mb-4 text-[#efe7dd]">
                1. Das Fundament
              </h4>
      ...
      <section className="relative py-24 px-6 md:px-12 lg:px-24 bg-[#111] border-t border-white/5 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-5/12">
            ...
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold font-serif-elegant mb-8 leading-[1.3] text-[#efe7dd]">
              Mein Ziel ist es, die Aktionärsquote in Deutschland von aktuell
              ca. 20 % deutlich zu steigern.
            </h3>
            <div className="border-l-2 border-[#e0937a] pl-6 py-2">
          ...
          <div className="w-full lg:w-7/12 flex flex-col gap-10">
            <div className="flex gap-6 items-start group">
              <div className="mt-1 bg-[#1a1a1a] p-4 rounded-xl border border-white/5 group-hover:border-[#e0937a]/50 transition-colors shadow-[0_5px_15px_rgba(0,0,0,0.5)]">
                <UserCheck className="w-8 h-8 text-[#e0937a] group-hover:scale-110 transition-transform drop-shadow-[0_0_8px_rgba(224,147,122,0.4)]" />
              </div>
              <div>
                <h4 className="text-xl font-bold text-[#efe7dd] mb-2 group-hover:text-[#e0937a] transition-colors">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-32">
            <div className="relative w-80 h-80 flex items-center justify-center group">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
                ...
                <span className="text-[11px] md:text-xs text-gray-400 tracking-widest uppercase mt-2 transition-all duration-500">
                  {centerData.label}
                </span>
              </div>
            </div>
            <div className="w-full max-w-md flex flex-col">
              <div className="space-y-2 mb-10">
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className="w-4 h-4 rounded-sm shadow-[0_0_8px_rgba(239,231,221,0.6)]"
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className="w-4 h-4 rounded-sm shadow-[0_0_10px_rgba(224,147,122,0.7)]"
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className="w-4 h-4 rounded-sm shadow-[0_0_10px_rgba(197,160,89,0.7)]"
              ...
              <div className="mt-12 p-6 border border-[#e0937a]/30 rounded-xl bg-gradient-to-r from-[#e0937a]/15 via-[#1a1a1a] to-[#111] flex justify-between items-center shadow-[0_10px_30px_rgba(224,147,122,0.2)] hover:shadow-[0_15px_40px_rgba(224,147,122,0.35)] hover:border-[#e0937a]/60 transition-all duration-500 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <span className="text-lg font-bold text-[#efe7dd]">
                    Full FIRE Status
                  </span>
                </div>
                <span className="font-serif-elegant text-[#efe7dd] font-bold text-4xl drop-shadow-[0_0_15px_rgba(224,147,122,0.6)] relative z-10">
                  2036
                </span>
              </div>
            </div>
          ...
          <div className="bg-[#111] rounded-2xl border border-white/5 p-8 md:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.5)] relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
              <div className="text-center p-8 rounded-xl border border-red-900/30 bg-red-900/10 relative overflow-hidden group hover:border-red-900/50 transition-colors">
                ...
                <div className="text-4xl md:text-5xl font-bold text-red-400/90 mb-4 font-serif-elegant">
                  {kaufkraft.toLocaleString("de-DE")} €
                </div>
                <div className="inline-flex items-center gap-2 text-red-400/90 bg-red-400/10 px-4 py-2 rounded-full text-sm font-medium">
              ...
              <div className="text-center p-8 rounded-xl border border-[#e0937a]/30 bg-[#e0937a]/5 relative overflow-hidden group hover:border-[#e0937a]/60 hover:shadow-[0_0_30px_rgba(224,147,122,0.15)] transition-all duration-500">
                ...
                <div className="text-4xl md:text-5xl font-bold text-[#e0937a] mb-4 font-serif-elegant drop-shadow-[0_0_10px_rgba(224,147,122,0.4)]">
                  {etfWert.toLocaleString("de-DE")} €
                </div>
                <div className="inline-flex items-center gap-2 text-green-400 bg-green-400/10 px-4 py-2 rounded-full text-sm font-medium">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="bg-[#1a1a1a] p-8 md:p-10 rounded-xl border border-white/5 relative overflow-hidden group flex flex-col h-full hover:-translate-y-2 hover:border-[#e0937a]/40 hover:bg-gradient-to-br hover:from-[#1a1a1a] hover:to-[#e0937a]/10 hover:shadow-[0_15px_40px_-10px_rgba(224,147,122,0.35)] transition-all duration-500">
              ...
              <div className="relative z-10 flex flex-col flex-1 h-full">
                ...
                <div className="pt-6 border-t border-white/10 mt-auto min-h-[180px] flex flex-col justify-start">
                  ...
                  <p className="text-[#efe7dd] font-medium leading-relaxed text-[13px] md:text-sm">
          ...
          <div className="max-w-4xl mx-auto bg-[#1a1a1a] border border-[#e0937a]/50 p-10 rounded-2xl shadow-[0_10px_40px_-10px_rgba(224,147,122,0.2)] mb-16 relative overflow-hidden text-left group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6 border-b border-[#e0937a]/20 pb-4">
                <Target className="w-10 h-10 text-[#e0937a] drop-shadow-[0_0_8px_rgba(224,147,122,0.5)]" />
                <h4 className="text-2xl md:text-3xl font-serif-elegant font-bold text-[#efe7dd]">
                  Das Yagibasan Extra: Die 100-Euro-Challenge
                </h4>
              </div>
              <div className="space-y-6">
                <div>
                  <span className="text-[#e0937a] font-bold tracking-widest uppercase text-sm block mb-1">
                    Was wir machen:
                  </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="w-full flex justify-center">
              <div className="relative w-full max-w-lg aspect-[4/3] bg-[#222] border border-[#e0937a]/30 rounded-xl shadow-[0_0_50px_rgba(224,147,122,0.15)] hover:shadow-[0_0_80px_rgba(224,147,122,0.4)] transition-shadow duration-500 flex flex-col items-center justify-center p-8 text-center overflow-hidden">
                ...
                <a
                  href="#pakete"
                  className="bg-[#e0937a] text-[#1a1a1a] font-bold px-8 py-4 rounded-sm hover:bg-[#efe7dd] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(224,147,122,0.6)] transition-all duration-300"
                >
                  Zu den Preisen
                </a>
              </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-5xl font-bold uppercase mb-4">
              Wähle deinen Weg
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-8 flex flex-col opacity-90 hover:opacity-100 transition-opacity">
              ...
              <div className="text-4xl font-bold mb-6 text-[#efe7dd]">
                0 €{" "}
              ...
              <ul className="space-y-4 mb-10 flex-1 text-sm text-gray-400">
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-[#e0937a] flex-shrink-0" />{" "}
                  Basis-Finanzwissen
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-[#e0937a] flex-shrink-0" /> Der
                  Excel-Budgetplaner
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-[#e0937a] flex-shrink-0" />{" "}
                ...
                <li className="flex items-center gap-3 text-gray-600">
                  <X className="w-5 h-5 flex-shrink-0" /> Einblick in
                  Aktien-Käufe
                </li>
                <li className="flex items-center gap-3 text-gray-600">
                  <X className="w-5 h-5 flex-shrink-0" /> Dividendenkalender &
                  Analysen
                </li>
                <li className="flex items-center gap-3 text-gray-600">
                  <X className="w-5 h-5 flex-shrink-0" /> 1:1 Betreuung
                </li>
              </ul>
              <a
                href="#newsletter"
                className="w-full text-center border border-gray-600 text-gray-300 font-bold px-6 py-4 rounded-sm hover:bg-gray-800 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all duration-300"
              >
                Kostenlos mitlesen
              </a>
            </div>
            <div className="bg-gradient-to-b from-[#1a1a1a] to-[#e0937a]/15 border-2 border-[#e0937a] rounded-xl p-8 flex flex-col transform md:-translate-y-4 shadow-[0_0_40px_rgba(224,147,122,0.3)] hover:shadow-[0_0_70px_rgba(224,147,122,0.5)] transition-all duration-500 relative z-10">
              ...
              <h4 className="text-2xl font-serif-elegant mb-2 text-[#e0937a] drop-shadow-[0_0_8px_rgba(224,147,122,0.4)]">
                Premium
              </h4>
              <div className="text-4xl font-bold mb-6 text-[#efe7dd]">
                19 €{" "}
              ...
              <ul className="space-y-4 mb-10 flex-1 text-sm text-gray-300">
                ...
                <li className="flex items-center gap-3 text-gray-600">
                  <X className="w-5 h-5 flex-shrink-0" /> 1:1 Individuelles
                  Coaching
                </li>
              </ul>
              <div className="mt-auto flex flex-col gap-3">
                <a
                  href="#"
                  className="w-full text-center bg-[#e0937a] text-[#1a1a1a] font-bold px-6 py-4 rounded-sm hover:bg-[#efe7dd] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(224,147,122,0.6)] transition-all duration-300"
                >
                  Premium sichern
                </a>
                <p className="text-[11px] text-gray-400 text-center font-light">
                  Keine Mindestlaufzeit. Jederzeit mit einem Klick kündbar.
                </p>
              </div>
            </div>
            <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-8 flex flex-col hover:border-[#e0937a]/40 hover:bg-gradient-to-b hover:from-[#1a1a1a] hover:to-[#e0937a]/10 hover:shadow-[0_0_35px_rgba(224,147,122,0.25)] transition-all duration-500 group">
              ...
              <ul className="space-y-4 mb-10 flex-1 text-sm text-gray-400">
                ...
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-[#e0937a] flex-shrink-0" /> Das
              ...
              <a
                href="#mentoring"
                onClick={handleOpenModal}
                className="w-full text-center border-2 border-[#e0937a] text-[#e0937a] font-bold px-6 py-4 rounded-sm hover:bg-[#e0937a] hover:text-[#1a1a1a] hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(224,147,122,0.4)] transition-all duration-300"
              >
                Jetzt bewerben
              </a>
            </div>
      ...
      <section className="relative py-20 px-6 md:px-12 lg:px-24 overflow-hidden bg-[#1a1a1a]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <a
              href="#"
              className="group block bg-[#111] border border-[#e0937a]/20 p-8 rounded-lg hover:border-[#e0937a]/60 hover:bg-gradient-to-br hover:from-[#111] hover:to-[#e0937a]/15 hover:-translate-y-2 hover:shadow-[0_15px_40px_-10px_rgba(224,147,122,0.35)] transition-all duration-500 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity">
                <ExternalLink className="w-4 h-4 text-[#e0937a]" />
              </div>
              <h4 className="text-2xl font-serif-elegant mb-3 text-[#efe7dd]">
                Trade Republic
              </h4>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto bg-gradient-to-r from-[#e0937a] to-[#c07a63] p-[2px] rounded-xl shadow-[0_0_35px_rgba(224,147,122,0.3)] hover:shadow-[0_0_50px_rgba(224,147,122,0.4)] transition-shadow duration-500">
          <div className="bg-[#1a1a1a] p-10 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 rounded-[10px]">
            <div>
              <h3 className="text-2xl md:text-3xl font-serif-elegant font-bold text-[#efe7dd] mb-3 flex items-center gap-3">
                <Mail className="w-6 h-6 text-[#e0937a]" />
                Mein Newsletter
              </h3>
            ...
            <div className="w-full md:w-auto flex flex-col gap-4">
              <a
                href="#"
                className={`w-full text-center font-bold px-8 py-4 rounded-sm transition-all duration-300 whitespace-nowrap ${
                  !newsletterConsent
              ...
              <label className="flex items-start gap-3 cursor-pointer group max-w-sm">
                <input
                  ...
                  className="mt-1 w-4 h-4 accent-[#e0937a] cursor-pointer flex-shrink-0"
                />
                <span className="text-[11px] text-gray-400 font-light leading-relaxed text-left">
                  Ich habe die{" "}
                  <a
                    href="#datenschutz"
                    className="text-[#e0937a] hover:underline transition-all"
      ...
      <section className="relative bg-[#1a1a1a] py-20 px-6 md:px-12 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-24">
            ...
            <form className="flex flex-col gap-4 w-full">
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <input
                  ...
                  className="flex-1 bg-[#111] border border-white/10 px-6 py-4 rounded-sm text-[#efe7dd] focus:outline-none focus:border-[#e0937a] transition-colors"
                  required
                />
                <button
                  disabled={!budgetConsent}
                  className={`w-full sm:w-fit font-bold px-10 py-4 rounded-sm transition-all duration-300 whitespace-nowrap flex items-center justify-center gap-2 ${
                    !budgetConsent
                      ? "bg-gray-700 text-gray-400 cursor-not-allowed opacity-70"
                      : "bg-[#e0937a] text-[#1a1a1a] hover:bg-[#efe7dd] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(224,147,122,0.6)]"
                  }`}
                >
                  <BookOpen className="w-5 h-5" /> Planer sichern
                </button>
              </div>
              <label className="flex items-start gap-3 cursor-pointer group mt-2">
                <input
                  ...
                  className="mt-1 w-4 h-4 accent-[#e0937a] cursor-pointer flex-shrink-0"
                />
                <span className="text-[11px] md:text-xs text-gray-400 font-light leading-relaxed text-left">
                  Ich habe die{" "}
                  <a
                    href="#datenschutz"
                    className="text-[#e0937a] hover:underline transition-all"
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="w-full max-w-lg aspect-video bg-[#222] border border-[#e0937a]/40 rounded-lg shadow-[0_0_40px_rgba(224,147,122,0.25)] flex flex-col items-center justify-center p-8 text-center relative overflow-hidden group hover:border-[#e0937a]/70 hover:shadow-[0_0_60px_rgba(224,147,122,0.4)] transition-all duration-500">
              <div className="absolute top-0 left-0 w-full h-8 bg-[#333] flex items-center px-4 gap-2 border-b border-black/50">
                <div className="w-2 h-2 rounded-full bg-red-500"></div>
                <div className="w-2 h-2 rounded-full bg-yellow-500"></div>
                <div className="w-2 h-2 rounded-full bg-green-500"></div>
              </div>
              <BarChart className="w-16 h-16 text-[#e0937a] mb-4 mt-4 group-hover:scale-110 transition-transform drop-shadow-[0_0_8px_rgba(224,147,122,0.4)]" />
              <h4 className="font-serif-elegant text-xl mb-2 text-[#efe7dd]">
      ...
      <section className="relative py-24 px-6 md:px-12 lg:px-24 bg-[#111] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-5xl font-bold uppercase mb-4 text-[#e0937a] drop-shadow-[0_0_15px_rgba(224,147,122,0.2)]">
              Hast du noch Fragen?
            </h3>
            <p className="text-gray-400 font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="font-semibold text-[15px] text-[#efe7dd] pr-4">
                    {faq.question}
                  </span>
                  <ChevronDown
                    className={`w-5 h-5 text-[#e0937a] flex-shrink-0 transition-transform duration-300 ${
                ...
                >
                  <p className="p-6 pt-0 text-gray-400 leading-relaxed font-light text-sm">
                    {faq.answer}
                  </p>
                </div>
              </div>
      ...
      <footer className="bg-[#0a0a0a] border-t border-white/5 py-12 px-6 md:px-12 lg:px-24 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[0.8fr_1.2fr_1fr_1.2fr] gap-12 text-left">
            ...
            <div className="flex flex-col gap-5 pl-12 lg:pl-8">
              ...
              <div className="flex items-center gap-4 group cursor-pointer mt-1 relative -ml-12">
                ...
                <a
                  ...
                  className="text-gray-400 font-light group-hover:text-[#e0937a] transition-colors whitespace-nowrap"
                >
            ...
            <div className="flex flex-col gap-4">
              ...
              <a
                href="#impressum"
                className="text-gray-400 font-light hover:text-[#e0937a] hover:translate-x-1 transition-all"
              >
                Impressum
              </a>
              <a
        ...
        <div className="mt-16 text-xs text-gray-600 relative z-10 border-t border-white/5 pt-8 font-light text-center max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-6 bg-black/80 backdrop-blur-md overflow-y-auto">
          <div className="relative w-full max-w-4xl bg-[#111] border border-[#e0937a]/30 rounded-2xl shadow-[0_0_50px_rgba(224,147,122,0.15)] my-auto flex flex-col max-h-[90vh]">
            <button
              ...
              className="absolute top-6 right-6 text-gray-400 hover:text-[#e0937a] hover:rotate-90 transition-all z-20"
            >
              <X className="w-8 h-8" />
            </button>
            <div className="p-8 md:p-12 overflow-y-auto custom-scrollbar">
              {!isSuccess ? (
                <form onSubmit={handleSubmit} className="space-y-12">
                  <div className="text-center border-b border-white/10 pb-10">
                    <img
                      src="https://lh3.googleusercontent.com/d/1dj4_0mNEvkggbx4UsJRX0-BE25gBR-ol"
                      alt="Yagibasan Capital Logo"
                      className="w-32 h-32 md:w-40 md:h-40 mx-auto object-contain mb-6 drop-shadow-[0_0_15px_rgba(224,147,122,0.3)]"
                    />
                    <h2 className="text-[#e0937a] text-sm font-bold tracking-[0.2em] uppercase mb-2">
                      Mentoring-Audit
                    </h2>
                    <h3 className="text-3xl md:text-4xl font-bold font-serif-elegant text-[#efe7dd] mb-4">
                      Der Status Quo
                    </h3>
                        ...
                        <div className="flex flex-wrap gap-6 mt-1">
                          <label className="flex items-center gap-2 cursor-pointer group">
                            <input
                              type="radio"
                              name="sparen"
                              className="accent-[#e0937a] w-4 h-4"
                            />
                            <span className="text-gray-400 group-hover:text-[#efe7dd]">
                              Automatisiert
                            </span>
                          </label>
                          <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  <div className="space-y-8 bg-[#1a1a1a] p-8 rounded-xl border border-white/5">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <select className="w-full bg-[#111] border border-white/10 rounded-sm px-4 py-3 text-[#efe7dd] focus:outline-none focus:border-[#e0937a] focus:shadow-[inset_0_0_10px_rgba(224,147,122,0.1)] transition-all cursor-pointer">
                  ...
                  <div className="bg-[#1a1a1a] p-6 rounded-xl border border-white/5 mt-8">
                    <label className="flex items-start gap-4 cursor-pointer group">
                      <input
                        ...
                        className="mt-1 w-5 h-5 accent-[#e0937a] flex-shrink-0 cursor-pointer"
                      />
                  ...
                  <div className="pt-8 flex justify-center">
                    <button
                      ...
                      className={`group flex items-center gap-3 font-bold px-12 py-5 rounded-sm transition-all duration-300 ${
                    ...
                    >
                      {isSubmitting ? (
                        <>
                          <Loader2 className="w-6 h-6 animate-spin" /> Audit
                          wird übermittelt...
                        </>
                      ) : (
                        <>
                          <Send className="w-6 h-6" /> Audit absenden &
                ...
                <div className="text-center py-20 flex flex-col items-center">
                  <div className="w-24 h-24 bg-[#e0937a]/20 rounded-full flex items-center justify-center mb-8">
                    <Check className="w-12 h-12 text-[#e0937a]" />
                  </div>
                  <h3 className="text-3xl font-bold font-serif-elegant text-[#efe7dd] mb-4">
                  ...
                  <button
                    onClick={handleCloseModal}
                    className="mt-10 bg-[#e0937a] text-[#1a1a1a] font-bold px-10 py-4 rounded-sm hover:bg-[#efe7dd] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(224,147,122,0.6)] transition-all duration-300"
                  >
                    Schließen
                  </button>
                </div>
