...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-[#efe7dd] font-['Montserrat',sans-serif] selection:bg-[#e0937a] selection:text-[#1a1a1a] flex flex-col">
            ...
            {!isBudgetSuccess ? (
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full">
                  ...
                  >
                    {isBudgetSubmitting ? (
                      ...
                      <>
                        <BookOpen className="w-4 h-4 sm:w-5 sm:h-5" /> Planer
                        sichern
                      </>
                    )}
                  </button>
              ...
              <div className="bg-[#e0937a]/10 border border-[#e0937a]/30 rounded-sm p-4 sm:p-6 flex items-center gap-3 sm:gap-4 shadow-[inset_0_0_15px_rgba(224,147,122,0.1)] w-full">
                ...
                <p className="text-[#efe7dd] text-sm sm:text-base leading-relaxed font-light">
                  Erfolgreich! Ich habe deine Anfrage erhalten und schicke dir
                  den Planer in Kürze per E-Mail zu.
                </p>
              </div>
            )}
      ...
      {isPremiumModalOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 sm:p-4 md:p-6 bg-black/90 sm:bg-black/80 backdrop-blur-md overflow-y-auto">
          <div className="relative w-full h-full sm:h-auto sm:max-w-3xl bg-[#111] sm:border border-[#e0937a]/30 sm:rounded-2xl shadow-[0_0_50px_rgba(224,147,122,0.15)] my-auto flex flex-col sm:max-h-[90vh]">
            <button
            ...
            <div className="p-5 sm:p-8 md:p-12 overflow-y-auto custom-scrollbar h-full">
              <div className="text-center border-b border-white/10 pb-8 sm:pb-10 pt-4 sm:pt-0">
                ...
                />
                <h2 className="text-[#e0937a] text-xs sm:text-sm font-bold tracking-[0.2em] uppercase mb-2">
                  Yagibasan Capital Premium
                </h2>
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold font-serif-elegant text-[#efe7dd] mb-3 sm:mb-4">
                  Werte für Generationen
                </h3>
                <p className="text-gray-400 font-light text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
                  Der geschlossene Bereich für deinen strategischen
                  Vermögensaufbau – fundiert, transparent und auf Augenhöhe.
                </p>
              </div>

              <div className="space-y-6 sm:space-y-8 bg-[#1a1a1a] p-5 sm:p-8 rounded-xl border border-white/5 mt-8 sm:mt-10">
                <h4 className="text-lg sm:text-xl font-bold text-[#e0937a] border-b border-[#e0937a]/20 pb-2 sm:pb-3">
                  Deine Vorteile
                </h4>
                <ul className="space-y-4 sm:space-y-5">
                  <li className="flex items-start gap-3 sm:gap-4">
                    <Check className="w-5 h-5 sm:w-6 sm:h-6 text-[#e0937a] flex-shrink-0 mt-0.5" />
                    <span className="text-[#efe7dd] text-sm sm:text-base font-light leading-relaxed">
                      Exklusiver Zugang zu allen Premium-Artikeln
                    </span>
                  </li>
                  <li className="flex items-start gap-3 sm:gap-4">
                    <Check className="w-5 h-5 sm:w-6 sm:h-6 text-[#e0937a] flex-shrink-0 mt-0.5" />
                    <span className="text-[#efe7dd] text-sm sm:text-base font-light leading-relaxed">
                      Transparenter Dividendenkalender & Depot-Updates
                    </span>
                  </li>
                  <li className="flex items-start gap-3 sm:gap-4">
                    <Check className="w-5 h-5 sm:w-6 sm:h-6 text-[#e0937a] flex-shrink-0 mt-0.5" />
                    <span className="text-[#efe7dd] text-sm sm:text-base font-light leading-relaxed">
                      Fundierte Aktien-Analysen und klare Strategien
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="pt-8 sm:pt-10 flex flex-col items-center justify-center">
                <div className="mb-6 sm:mb-8 text-center">
                  {!isYearly ? (
                    <div className="text-3xl sm:text-4xl font-bold text-[#efe7dd]">
                      20,00 €{" "}
                      <span className="text-base sm:text-lg text-gray-400 font-light">
                        / Monat
                      </span>
                    </div>
                  ) : (
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="bg-[#e0937a]/10 text-[#e0937a] border border-[#e0937a]/30 px-3 py-1 rounded text-[10px] sm:text-xs font-bold uppercase tracking-widest shadow-[0_0_10px_rgba(224,147,122,0.1)]">
                        2 Monate geschenkt
                      </span>
                    </div>
                  )}
                ...
                <a
                  href={
                    isYearly
                      ? "https://buy.stripe.com/eVqcN5eHG6ZS1J8a337ok02"
                      : "https://buy.stripe.com/00w5kDeHG1FyfzYfnn7ok01"
                  }
                  className="group flex items-center justify-center gap-2 sm:gap-3 font-bold px-6 sm:px-12 py-4 sm:py-5 rounded-sm transition-all duration-300 w-full sm:w-auto text-sm sm:text-base bg-[#e0937a] text-[#1a1a1a] hover:bg-[#efe7dd] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(224,147,122,0.6)]"
                >
                  <Lock className="w-5 h-5 sm:w-6 sm:h-6" /> Zahlungspflichtig
                  bestellen
                </a>

                <p className="text-gray-500 text-[10px] sm:text-xs mt-4 font-light text-center leading-relaxed">
                  Du wirst zur sicheren Zahlung über Stripe weitergeleitet.
                  <br />
                  {isYearly
                    ? "Gewähltes Intervall: Jährlich"
                    : "Gewähltes Intervall: Monatlich"}
